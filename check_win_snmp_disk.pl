...
foreach $LDISK (@LDISKS){
	...
	if ( $PERCENTUSED < $WARN ) { 
		...
		$LONGOUTPUT.="\nDISK $DISKNAME: OK \(Used: $PERCENTUSED%\) Total: $TOTAL$TOTALUNITS Used: $USED$USEDUNITS Free: $FREE$FREEUNITS";
	...
	if ( $PERCENTUSED < $CRITICAL ) { 
		$LONGOUTPUT.="\nDISK $DISKNAME: WARNING \(Used: $PERCENTUSED%\) Total: $TOTAL$TOTALUNITS Used: $USED$USEDUNITS Free: $FREE$FREEUNITS"; 
		$PERFOUTPUT.="\'Disk $DISKNAME\'=$USED$TOTALUNITS;$WARNSIZE;$CRITSIZE;0;$TOTAL \'Disk $DISKNAME\'=$PERCENTUSED%;$WARN;$CRITICAL ";
	...
	if ( $PERCENTUSED >= $CRITICAL ) {
		$LONGOUTPUT.="\nDISK $DISKNAME: CRITICAL \(Used: $PERCENTUSED%\) Total: $TOTAL$TOTALUNITS Used: $USED$USEDUNITS Free: $FREE$FREEUNITS";
		$PERFOUTPUT.="\'Disk $DISKNAME\'=$USED$TOTALUNITS;$WARNSIZE;$CRITSIZE;0;$TOTAL \'Disk $DISKNAME\'=$PERCENTUSED%;$WARN;$CRITICAL ";
